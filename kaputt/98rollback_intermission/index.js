$( () => {
    ...
    $.getJSON("/data", data => {
        ...
        if (parseInt(data.p1_score) >= parseInt(data.max_score)) {
            // $(".p1_name").css("text-shadow", "0 0 10px magenta, 0 0 10px magenta")
        }
        if (parseInt(data.p2_score) >= parseInt(data.max_score)) {
            // $(".p2_name").css("text-shadow", "0 0 10px magenta, 0 0 10px magenta")
        }
    ...
    setInterval(() => {
        $.getJSON("/data", data => {
            ...
            if (parseInt(data.p1_score) >= parseInt(data.max_score)) {
                ...
                // $(".p1_name").css("text-shadow", "0 0 8px black, 0 0 8px black");
            }
            if (parseInt(data.p2_score) >= parseInt(data.max_score)) {
                // $(".p2_name").css("text-shadow", "0 0 10px magenta, 0 0 10px magenta")
            } else {
                // $(".p2_name").css("text-shadow", "0 0 8px black, 0 0 8px black");
            }
